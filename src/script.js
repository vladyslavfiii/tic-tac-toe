...
document.body.firstElementChild.setAttribute('class', 'ticTacToe');
...
document.querySelector('.ticTacToeScore').firstElementChild.setAttribute('class', 'ticTacToeScoreBlock');

document.querySelector('.ticTacToeScoreBlock').appendChild(document.createElement('div'));
document.querySelector('.ticTacToeScoreBlock').firstElementChild.setAttribute('class', 'ticTacToeScoreBlockValue');
document.querySelector('.ticTacToeScoreBlock').firstElementChild.innerText = "X Scores:"

document.querySelector('.ticTacToeScoreBlock').appendChild(document.createElement('div'));
document.querySelector('.ticTacToeScoreBlock').lastElementChild.setAttribute('class', 'ticTacToeScoreBlockValue');
document.querySelector('.ticTacToeScoreBlock').lastElementChild.innerText = "O Scores:"
...
function win(e){
	...
	document.querySelector('.ticTacToeTable').appendChild(document.createElement('div'));
	document.querySelector('.ticTacToeTable').lastElementChild.setAttribute('class', 'win');

	if (e != "nobody") {
		if (e === "crosses") {document.querySelector('.ticTacToeScoreBlock').firstElementChild.innerText = "X Scores:"+ crossesWons; crossesWons += 1;}
		if (e === "noughts") {document.querySelector('.ticTacToeScoreBlock').lastElementChild.innerText = "O Scores:"+ noughtsWons; noughtsWons += 1;}
	}
